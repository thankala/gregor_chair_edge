...
parsers = {
    ...
    # Homing function
    30: [lambda x: struct.unpack('<' + 'f' * 4, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<' + 'f' * 4, *x))],
    31: [None, None, lambda x: struct.unpack('<Q', bytearray(x))[0], lambda x: list(struct.pack('<f', *x))],
    32: [lambda x: struct.unpack('<Bf', bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
    ...
    # End effector
    60: [lambda x: struct.unpack('<' + 'f' * 3, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<' + 'f' * 4, *x))],
    61: [lambda x: (x[0] == 1, x[1] == 2), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<BB', *x))],
    62: [lambda x: (x[0] == 1, x[1] == 2), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<BB', *x))],
    63: [lambda x: (x[0] == 1, x[1] == 2), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<BB', *x))],
    # JOG
    70: [lambda x: struct.unpack('<' + 'f' * 8, bytearray(x)), None, None,
         lambda x: list(struct.pack('<' + 'f' * 8, *x))],
    71: [lambda x: struct.unpack('<' + 'f' * 8, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<' + 'f' * 8, *x))],
    72: [lambda x: struct.unpack('<' + 'f' * 2, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<' + 'f' * 2, *x))],
    73: [None, None, lambda x: struct.unpack('<Q', bytearray(x))[0], lambda x: list(struct.pack('<' + 'B' * 2, *x))],
    74: [lambda x: struct.unpack('<' + 'f' * 2, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<' + 'f' * 2, *x))],
    # PTP
    80: [lambda x: struct.unpack('<' + 'f' * 8, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<' + 'f' * 8, *x))],
    81: [lambda x: struct.unpack('<' + 'f' * 4, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<' + 'f' * 4, *x))],
    82: [lambda x: struct.unpack('<' + 'f' * 2, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<' + 'f' * 2, *x))],
    83: [lambda x: struct.unpack('<' + 'f' * 2, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<' + 'f' * 2, *x))],
    84: [None, None, lambda x: struct.unpack('<Q', bytearray(x))[0], lambda x: list(struct.pack('<Bffff', *x))],
    85: [lambda x: struct.unpack('<' + 'f' * 2, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
         lambda x: list(struct.pack('<' + 'f' * 2, *x))],
    86: [None, None, lambda x: struct.unpack('<Q', bytearray(x))[0], lambda x: list(struct.pack('<Bfffff', *x))],
    87: [lambda x: struct.unpack('<' + 'f' * 3, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
    ...
    # Continuous path
    90: [lambda x: struct.unpack('<fffB', bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
    ...
    # Arc
    100: [lambda x: struct.unpack('<' + 'f' * 4, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
          lambda x: list(struct.pack('<' + 'f' * 4, *x))],
    ...
    # EIO
    130: [lambda x: struct.unpack('<B' * 2, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
          lambda x: list(struct.pack('<' + 'B' * 2, *x))],
    131: [lambda x: struct.unpack('<B' * 2, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
          lambda x: list(struct.pack('<' + 'B' * 2, *x))],
    132: [lambda x: struct.unpack('<Bff', bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
    ...
    137: [lambda x: struct.unpack('<B' * 3, bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
          lambda x: list(struct.pack('<' + 'B' * 3, *x))],
    138: [lambda x: struct.unpack('<B', bytearray(x)), None, lambda x: struct.unpack('<Q', bytearray(x))[0],
          lambda x: list(struct.pack('<' + 'B' * 3, *x))],
    # Calibration
    140: [lambda x: struct.unpack('<' + 'f' * 2, bytearray(x)), None, None,
          lambda x: list(struct.pack('<' + 'f' * 2, *x))],
    # Wifi
